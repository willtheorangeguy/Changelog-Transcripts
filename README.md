<!-- Logo -->
<h1 align="center">The Changelog Transcripts</h1>
...
<div align="center">
  ...
  <img alt="License" src="https://img.shields.io/github/license/willtheorangeguy/Changelog-Transcripts">
</div>
...
- Downloads and converts every episode across all 13 shows in the feed.
...
That runs the whole pipeline end to end. It covers `Away from Keyboard`, `Backstage`, `Brain Science`, `Changelog Interviews`, and 9 more.
...
Open a [GitHub Discussion](https://github.com/willtheorangeguy/Changelog-Transcripts/discussions/new) or file an [issue](https://github.com/willtheorangeguy/Changelog-Transcripts/issues/new/choose).
...
**The transcripts are not.** They are machine-generated from recordings of Changelog Podcast Universe podcast episodes, and the words belong to their speakers and rights holders. See [`CONTENT_LICENSE.md`](CONTENT_LICENSE.md) before reusing any of it.
