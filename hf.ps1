...
$PodcastRepoBase = ($PodcastFolder -replace ' ', '-')
...
foreach ($Year in $YearFolders)
{
    ...
    $RepoId = "$Year-$PodcastRepoBase-Transcripts"
    $PrettyName = "$Year $PodcastFolder"
...
- podcast
- show
pretty_name: $PrettyName Transcripts
---

# $PrettyName Transcripts
Complete transcripts from the $Year episodes of the $PodcastFolder podcast.
