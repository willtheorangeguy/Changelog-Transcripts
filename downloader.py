...
Changelog Transcripts GitHub repository. 
"""
import os
import zipfile
import requests
...
def unzip_file(zip_path):
    ...
    extracted_folder = os.path.join(cwd, "Changelog-Transcripts-main")
    if os.path.exists(extracted_folder):
        new_folder_name = "Changelog-Transcripts"
...
if __name__ == "__main__":
    # URL of Changelog Transcripts GitHub repository zip file
    url = "https://github.com/willtheorangeguy/Changelog-Transcripts/archive/refs/heads/main.zip"
    output_zip = "changelog_transcripts.zip"
