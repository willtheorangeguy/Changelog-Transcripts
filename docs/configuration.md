# The Changelog Transcripts — Configuration
...
| Ollama model | `llama3.1:8b` | `6_summarizer.py` | Summary quality; must already be pulled in Ollama |
| Summary chunk size | `2000 tokens` | `6_summarizer.py` | How much context each summarisation pass sees |
| Chunking tokenizer | `bert-base-uncased` | `6_summarizer.py` | Only used to measure chunk length, not to generate text |
