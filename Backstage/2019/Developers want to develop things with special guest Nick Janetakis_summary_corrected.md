• Domain name purchasing as a roadblock for projects
• Personal background of Nick Abenakis (Greek-American from Long Island)
• Criticism of digital nomad lifestyle blogs
• Discussion of Backstage podcast and connection between Jerold Santo and Nick Abenakis
• Overview of Nick Abenakis' professional experience and online content creation
• Description of Nick's application-building project using Phoenix with Elixir
• Comparison of building own course platform vs. using existing platforms like Thinking or Teachable
...
• Nick Abenakis used the CMS as a reference point for building his own application, pulling out components that he liked and adapting them to his needs
• Jerold Santo reflects on his approach to coding, which tends to result in non-reusable libraries and code, rather than general-purpose packages or modules.
...
• Nick Abenakis' experience with and value on newsletters
...
• Nick Abenakis shares his experience with audio recording equipment for creating online courses
• He started with a non-RadioShack microphone and later upgraded to ASIA Link Pro on Windows
• The developer of ASIA Link Pro passed away, causing issues with the software's registration server key
• Nick now uses a $60 dynamic mic, an audio interface (Scarlett 2i2), and the DBX286S for noise cancellation and compression
• He also discusses his editing process using Catania and OBS
...
• Jerold Santo shares his own experiences with Linux and hardware compatibility issues
• Discussion about the capabilities of Synergy software for merging multiple computers into one cohesive experience
• Jerold Santo and Nick Abenakis reminisce about using Synergy in the past
• Nick Abenakis mentions a similar setup he's working on now using native Linux hardware
