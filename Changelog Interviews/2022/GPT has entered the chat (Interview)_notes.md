...
- [Multiverse, not Metaverse](https://lspace.swyx.io/p/multiverse-not-metaverse)
- [The Particle/Wave Duality Theory of Knowledge](https://www.swyx.io/particle-wave-duality)
- [OpenRAIL: Towards open and responsible AI licensing frameworks](https://huggingface.co/blog/open_rail)
- [Open-ish from Luis Villa](https://www.openml.fyi/author/luis/)
...
- [Debugging code](https://twitter.com/jdjkelly/status/1598140764244299776)
- [TypeScript answer is wrong](https://twitter.com/SeaRyanC/status/1598515753942384640)
...
- [Moving to Obsidian as a Public Second Brain](https://www.swyx.io/obsidian-brain)